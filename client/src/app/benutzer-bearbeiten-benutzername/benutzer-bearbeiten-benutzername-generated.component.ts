/*
  ...
  Modify benutzer-bearbeiten-benutzername.component.ts instead.
*/
...
export class BenutzerBearbeitenBenutzernameGenerated implements AfterViewInit, OnInit, OnDestroy {
  // Components
  ...
  load() {
    this.dbSinDarEla.getVwBenutzerAnus(`Id eq '${this.parameters.Id}'`, null, null, null, null, null, null, null)
    .subscribe((result: any) => {
      this.benutzer = result.value[0];
    }, (result: any) => {
